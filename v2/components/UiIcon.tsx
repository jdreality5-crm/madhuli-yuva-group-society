...
type Name='dashboard'|'property'|'users'|'calendar'|'notice'|'gallery'|'payment'|'report'|'edit'|'trash'|'document'|'camera'|'refresh'|'check'|'home'|'add'|'close'|'arrowRight'|'print'|'download'|'more';
