...
type LoginUser={id:string;email:string;name:string;role:'MASTER_ADMIN'|'ORGANIZER'|'OWNER';societyId:string;status:string;approvalStatus:string;emailVerified:boolean;firebaseUid?:string|null;unitId?:string|null;residentType?:string|null;mobile?:string|null;permissions:string[];passwordHash?:string|null;loginLockedUntil?:string|null;failedLoginAttempts:number;emailLockedUntil?:string|null;mobileLockedUntil?:string|null};
