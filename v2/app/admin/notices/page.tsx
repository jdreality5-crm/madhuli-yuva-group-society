...
export default function NoticesPage(){
  ...
  return <main className="main notices-page">
    <div className="page-title"><div><p className="eyebrow">COMMUNITY • NOTICES</p><h1>Notices / જાહેર સૂચના</h1><p>Create society notices using the original Madhuli Yuva Group letterhead.</p></div><button className="btn btn-secondary" onClick={load}><UiIcon name="refresh" size={17}/> Refresh</button></div>
