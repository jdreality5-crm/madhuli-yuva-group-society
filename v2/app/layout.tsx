...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="gu" className={inter.variable + ' ' + gujarati.variable + ' ' + playfair.variable}><body>{children}<ProfileLogoutGate /><MobileAppShellFix /><PwaInstallPrompt /></body></html>;
}
